...
338 out of 1974 total appointments of all appointments held this semester were outside of B14. Note that the last week of appointments in the Fall semester had much lower form response rates, so it is likely that this does not truly capture the actual % of appointments held outside of B14. Overall, this shows the need to expand the Peer Academic Coaching spaces to adapt to the rapidly growing number of PAC appointments. 
